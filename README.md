The project implements the Naïve bayes classifier for 20-NewsGroup dataset, consisting of data from 20 different classes. It builds a probabilistic model that classifies the new document.
